...
/**
 * Vegan leaf glyph. Inlined (rather than an <img>) so it inherits `currentColor`
 * and stays visible in both light and dark themes.
 */
function VeganIcon({ className }: { className?: string }) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="currentColor"
 ...
 * is neither, so it can be dropped inline next to a title or featured star.
 */
